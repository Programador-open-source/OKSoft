...
public class UsergrupoPK implements Serializable {
    ...
    public UsergrupoPK(String utilizador, String idGrupo, Date dataAlocacao) {
    ...
    public String toString() {
        return "entidades.UsergrupoPK[ utilizador=" + utilizador + ", idGrupo=" + idGrupo + ", dataAlocacao=" + dataAlocacao + " ]";
    }
