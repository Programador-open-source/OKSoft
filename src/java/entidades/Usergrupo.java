 ...
 */
@Entity
@Table(name = "usergrupo", catalog = "customer_care", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Usergrupo implements Serializable {
    ...
    public Usergrupo(String utilizador, String idGrupo, Date dataAlocacao) {
        this.usergrupoPK = new UsergrupoPK(utilizador, idGrupo, dataAlocacao);
    }
